...
In this After Effects tutorial, Jenn Paulson covers rotating one object based on the position of the other object on the screen using the [Pick Whip](/education/tutorials/pick-whip-tool-and-character-rigging) tool.
