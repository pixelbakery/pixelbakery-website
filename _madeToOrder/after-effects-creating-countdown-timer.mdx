...
excerpt: This is a tutorial of how I made a countdown timer. This describes how to do
  keyframes, seconds, and minutes. To not do keyframes requires different
  mathmatics. For no keyframes, you will put %60 instead of %30 because of the
  seconds.
author:
  name: Shae Thompson
  url: https://www.linkedin.com/in/shea-c-thompson/
video: https://www.youtube.com/watch?v=UoVgcPH4aQE
type: _madeToOrder
draft: false
