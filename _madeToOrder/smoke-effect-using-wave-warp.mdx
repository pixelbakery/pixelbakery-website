...
excerpt: In this After Effects tutorial, Sky Hoscheit covers how to make a smoke effect using wave warp.
author:
...
In this After Effects tutorial, Sky Hoscheit covers the shape layer tool, pen tool, and how to use a wave warp to demonstrate a smoke effect.
