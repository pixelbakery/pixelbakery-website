          ...
          <section className=" mb-4 px-4 py-40  mx-auto max-h-screen bg-pink-light" id="benefits">
               ...
               <div className="col-span-3 flex flex-col justify-between mx-auto w-full gap-12">
                    <div className="mx-4 px-4">
                         <div>
                              <ul className="text-blue font-body font-extrabold text-xl relative benefitslist" id="awardslist1">
                                   ...
                                   <li className="my-2 benefit">open tab at  <a href="https://reactor.coffee" target="_blank">Reactor Coffee</a>.</li>
                                   ...
                                   <li className="my-2 benefit">access to pb's camera equiptment and studio for personal use</li>
                              </ul>
                         </div>
                    </div>
               </div>
