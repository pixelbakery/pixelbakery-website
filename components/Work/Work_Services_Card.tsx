...
export default function Work_Services_Card({ service, url }) {
  return (
    <Link href={url} passHref>
      <article className=' m-2 w-full md:w-2/5 flex-stretch hover:opacity-90 hover:scale-95 cursor-pointer'>
