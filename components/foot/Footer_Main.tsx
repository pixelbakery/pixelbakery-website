...
import Footer_Nav from '@foot/Footer_Nav'
import Footer_Nav_SubNav from '@foot/Footer_Nav_SubNav'
import Footer_HappyCard from '@foot/Footer_HappyCard'
import Logo_Type from '@parts/Logo_Type'
import Button_Filled from '@parts/Button_Filled'
import Footer_SocialLinks from '@foot/Footer_SocialLinks'
import Footer_Mailchimp2 from '@foot/Footer_Croissant'
