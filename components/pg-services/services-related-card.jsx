...
export default function RelatedWorkCard({project}){
    return(
        <article className=" portfolio-project aspect-w-3 xl:aspect-w-2 aspect-h-3 xl:aspect-h-3  w-full hover:opacity-90 hover:scale-95" >
