...
export default function LoadingModal({ visible }: { visible?: boolean }) {
  ...
  return visible ? (
    <div className='fixed z-50 inset-0 bg-wine bg-opacity-80 flex items-center justify-center'>
      <div className='text-2xl md:text-4xl font-black  uppercase modal-loading block '>
        <span className='text-peach px-1 md:px-2 modal-loading-span relative inline-block w-10 h-10'>
          L
        </span>
        ...
        <span className='text-pink px-1 md:px-2 modal-loading-span  relative inline-block'>N</span>
        <span className='text-peach px-1 md:px-2 modal-loading-span  relative inline-block'>G</span>
        <span className='text-yellow px-1 md:px-2 modal-loading-span  relative inline-block'>
          .
        </span>
