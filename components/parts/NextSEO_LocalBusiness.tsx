  ...
  return (
    <>
      <LocalBusinessJsonLd
        ...
        description='A creative studio based out of the midwest focused on animation, explainer videos, motion design, product photography, and commercial video production.'
