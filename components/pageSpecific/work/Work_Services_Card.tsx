...
export default function Work_Services_Card({ service, url }: Props) {
  return (
    <Link href={url} passHref>
      <article className='bg-pink-light overflow-hidden rounded-lg  w-full hover:opacity-90 hover:scale-98 cursor-pointer px-8 py-2  h-24 sm:h-28 xl:h-32  '>
        <div className='  flex flex-row  justify-between gap-4 h-full'>
          <div className='self-center'>
            <h3 className=' my-1 md:my-3 font-semibold lg:font-bold text-lg leading-none xl:text-2xl font-Heading text-pink'>
              {service}
            </h3>
          </div>
