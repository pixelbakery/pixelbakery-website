        ...
        <InnerWrapper className='py-2 my-2'>
          ...
          <div className='flex flex-row justify-end mt-16'>
            <Link
              ...
              className='font-geologica group relative  italic text-blue-dark text-lg flex flex-row justify-end align-middle'
              hrefLang='en-US'
              onClick={() =>
            ...
            >
              <span className='group-hover:scale-99 group-hover:underline inline leading-none self-center'>
                See Past Employees
              </span>
    ...
    return (
      <PageSection className='py-2 bg-pink-lighter' id={'bio-dismissed'}>
        <InnerWrapper className='flex flex-col justify-center py-2 my-2'>
          <H2 color={'blue-dark'} className='self-center mb-6 text-center font-geologica'>{`${
            firstName || 'This Person'
          } has since moved on from PB.`}</H2>
