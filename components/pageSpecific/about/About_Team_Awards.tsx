          ...
          <div className='col-span-6 xl:col-span-4'>
            ...
            >
              {awards.map((award, idx) => (
                <li
                  key={idx}
                  className='w-full pt-3 mb-1 lg:pt-3 lg:mb-3  text-blue-darker first:pt-0 last:mb-0'
                >
                  ...
                  ,
                  <p className='mt-1 text-balance xl:ml-5 italic text-blue-dark md:my-0 py-0 leading-none'>
                    <span className='font-semibold'>{award.client}</span>, {award.role}
                  </p>
                </li>
              ))}
            </ul>
