    ...
    <PageSection color='pink-light' className=' border-t-32 border-t-pink'>
      <InnerWrapper>
        ...
        <p className='max-w-md'>
          ...
          brand to life. They are flexible to our needs, super organized and responsive, and deliver
          really great results. I think the thing that I'm most impressed by is their ability to
          learn our brand and get better over time. That's the best thing you can ask for in a
          partner.”
        </p>
