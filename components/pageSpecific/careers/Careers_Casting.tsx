...
function Careers_Casting() {
  return (
    <section className='my-4 bg-white py-20' id='careers-casting'>
      <div className='mx-auto max-w-6xl flex gap-20'>
        <div className='w-1/2 h-full flex  flex-col justify-center'>
          <h2 className='text-blue '>casting calls</h2>
          <p className='text-wine font-bold opacity-80 text-2xl'>
            Efficiently cultivate interdependent value before economically sound paradigms
          </p>
        </div>
        <div className='w-1/2 py-12'>
          <div className='grid grid-cols-2 gap-8'>
            <Link hrefLang={'en-US'} href={'/'} className='col-span-1' legacyBehavior>
            ...
            <Link hrefLang={'en-US'} href={'/'} passHref className='col-span-1' legacyBehavior>
...
export default Careers_Casting
