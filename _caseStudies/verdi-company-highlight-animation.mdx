...
<PageSection id='verdi-web-banner'>
     <InnerWrapper className={"text-center"} center={true}>
          ...
          <Image src='https://cdn.pixelbakery.com/img/case-studies/verdi-company-highlight/Verdi_InstaWebBanner.jpg' alt="Verdi website banner" className={'mt-12 w-full h-auto'} width={1080} height={566} />
