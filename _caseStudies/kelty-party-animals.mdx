...
excerpt: 'How animation and motion graphics built a marketing campaign that brought to life party animals stealing a camper’s gear that is Kelty.'
vimeoID: '340232287'
...
<PageSection color={'white'} id={'other-videos'}>
  <InnerWrapper>
  <Video url={'https://vimeo.com/733685904'} title={'Character Timelapse'} muted={true} playsInline={true} loop={true} showPortrait={true} autoplay={true} controls={false} background={true}/>
  </InnerWrapper>
</PageSection>
