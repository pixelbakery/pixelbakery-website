...
ogImage:
  url: /img/blog/Rotating-Instagram-CDNs.jpg
---
...
`<Image layout='fill' objectFit='cover' className='instagram-image' key={index} src={item.media_url.replace(/^[^.]/, 'https://scontent-akl1-1')} alt={item.caption} quality={33}/>`
And it works!
