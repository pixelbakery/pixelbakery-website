...
excerpt: Writing a Google Script to help keep your work email sane. Learn how to auto delete/archive Gmail emails after a set time and stay organized.
# Cover Photos MUST be 4x3 resolution
coverImage: /img/blog/blogheader-pixelbakery-auto-delete-arcive-gmail.jpg
date: '2021-04-10'
...
Now for the good part. Let's get our script operational and running. In a new browser tab, navigate to [scripts.google.com](https://www.google.com/script/start/). Create a new script, name it, and paste our code into it. I have the default set to two days for both the 'autoDelete' and 'autoArchive' functions. You can change them by editing the variable delayDays on lines 3 and 35 respectively. Save your code.
