...
excerpt: An internal process document that we provide to New Hire. It outlines all of the different technologies, terminologies, apps, and programs that our employees will be using daily during their tenure with us.
...
All will begin trickling in shortly, but your first task is to create an email signature for your new, shiny pixelbakery.com email address: [https://pixelbakery.com/email-generator](https://pixelbakery.com/email-generator)
