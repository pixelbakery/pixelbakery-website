---
title: 'List of Video/Image Formats Supporting Alpha Channels'
subtitle: A list of modern video formats that support alpha channels (aka “transparency layers”)
excerpt: There's little info regarding alpha channels, so I wrote about it. This should be useful for Twitch streamers (stream overlays) and OBS/Streamlabs users.
# Cover Photos MUST be 4x3 resolution
coverImage: /img/blog/blogheader-ExampleOfAlphaLayers.jpg
date: '2023-01-01'
