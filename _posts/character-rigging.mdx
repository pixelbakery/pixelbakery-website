...
coverImage: /img/blog/blogheader-4x3_cow1.jpg
date: '2018-02-01'
...
3.  Crucify your [character in Illustrator](/recipes/class-tutorial-prepping-character-joints). Their arms, legs, tail, and head should be as outstretched to their natural limit. For us, that means out tail and legs will be stiff and straight.
...
We do, however, need to make sure our anchor points are properly set up. Grab the [Pan Behind tool](/education/tutorials/pan-behind-tool) (hotkey Y) and drag the anchor point on each layer to correspond with where the joint will be. For example: if we have a leg, we want the anchor point to be where it connects to the hip.
