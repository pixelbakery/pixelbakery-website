...
coverImage: /img/blog/pixel-bakery-BMPCC-6k-pro-gyro-stabilization-test.jpeg
categories:
  - Experimental
tags:
  - 7.9 Firmware Update
...
excerpt: Blackmagic just dropped a new Davinci and camera update, which means we get a
  new firmware update for our Blackmagic Pocket Cinema Camera 6k Pro! We flashed
  our camera with Firmware 7.9 and took it for a spin.
draft: false
