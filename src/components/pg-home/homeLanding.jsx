...
import PatternBlue from "../../img/pixelbakery_pattern_blue.svg";
      ...
      <section className='lander overflow-hidden w-full my-4 flex'>
            ...
            <div className='mx-auto mt-12' id='homepage-main-nav'>
              <ul className=''>
                <li className='my-1'>
                  <NavLink
                    to={"/work"}
                    className='text-pink font-bold lowercase text-4xl'
                  >
                    work
                  </NavLink>
                </li>
        ...
        <div className='flex-grow pb-pattern ' id='homepage-lander'>
          <div className=' flex flex-col mx-auto h-1/3 '>
            <img src={boxLogo} alt='' className='object-center block m-auto ' />
          </div>
        </div>
      </section>
    </div>
