            ...
            <section className="lander w-full my-4 flex">
                <nav className="w-1/3 max-w-lg bg-pink-light h-full flex flex-col justify-between py-10 px-12 ">
                            ...
                            <div className="logo-wrapper px-20 w-full text-blue fill-current">
                                <MainLogo color={"fill-pink"}/>
                                {/* <img 
                                    className=" object-center block m-auto object-contain w-full text-blue fill-current"
                    ...
                    <div className="mx-auto w-full px-4">
                        <div className="mx-auto mt-12" id="homepage-main-nav">
                            <ul className="">
                                <li className="my-2"><NavLink to={"/work"} className="text-pink font-bold lowercase text-4xl">work</NavLink></li>
                                <li className="my-2"><NavLink to={"/about"} className="text-pink font-bold lowercase text-4xl">bakery</NavLink></li>
                                <li className="my-2"><NavLink to={"/education"} className="text-pink font-bold lowercase text-4xl">education</NavLink></li>
                                <li className="my-2"><NavLink to={"/recipesss"} className="text-pink font-bold lowercase text-4xl">mom's recipes</NavLink></li>
