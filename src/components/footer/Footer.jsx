            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 mb-12 gap-8 h-full">
                ...
                <div className="flex flex-col justify-between h-full pr-6">
                    <div className="">
                        ...
                        <div>
                            <ul className="mt-3">
                                <li> <a className="text-cream text-xl" href="#">2124 y st ste 208<br/>lincoln, ne 68503</a></li>
                                <li className="mt-3 text-xl text-cream"><a href="tel:4024138366" target="_blank">402 413 8366</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="flex flex-col justify-between h-full">
                    ...
                    <div className="text-center mt-3">
                        <a className="text-cream  text-2xl font-extrabold" href="mailto:hello@pixelbakery.com" target="_blank">hello@pixelbakery.com</a>
                    </div>
                </div>
