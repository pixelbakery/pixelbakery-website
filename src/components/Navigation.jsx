...
function Navbar() {
  ...
  useLayoutEffect(() => {
    ...
    navTL
      ...
      .to(
        "#logo-line-1",
        { opacity: 1, y: 0, duration: 0.33, ease: "back.out," },
        "<33%"
      )
      .to(
        "#logo-line-2",
    ...
    tl.addLabel("start")
      ...
      .from(
        "#design-studio",
        { scale: 0.75, x: -26, y: -3, duration: 0.25 },
        "<25%"
      )
      .to("#d", { x: 3, ease: "sine.inOut", duration: 0.25 }, "<")
      .to(
        "#s",
        { x: -140, scaleY: 1.25, y: -4, ease: "sine.inOut", duration: 0.25 },
        "<33%"
      )
      .to(
        "#logo-bg",
        { height: 124, width: 90, ease: "sine.inOut", duration: 0.25 },
        "<"
      )
      ...
      .to(
        "#nav-link-1",
        { x: 300, scale: 0, opacity: 0, ease: "back.in", duration: 0.5 },
        "<"
      )
      .to(
        "#nav-link-2",
      ...
      .to(
        "#nav-link-3",
        { y: -20, opacity: 0, ease: "back.in", duration: 0.33 },
        "<33%"
      )
      .addLabel("end");
  });
        ...
        <div id='logo' className='opacity-0 origin-top-left'>
          ...
          >
            ...
            >
              <p
                id='logo-line-1'
                className='opacity-0 tracking-normal text-left'
              >
