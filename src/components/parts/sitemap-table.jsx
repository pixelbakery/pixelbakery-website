        ...
        <table className='w-full text-left border-collapse'>
          <thead>
            <tr className='text-md font-semibold text-wine text-opacity-90'>
              ...
              <th className='z-20 pt-8 sticky bg-pink-light top-0 p-0'>
                <div className='pb-3 px-2 border-b border-wine-300'>
                  React Component
                </div>
              </th>
              <th className='z-20 pt-8 sticky bg-pink-light top-0 p-0'>
                <div className='pb-3 pl-2 border-b border-wine-300 text-center'>
                  Active
                </div>
              </th>
            </tr>
          ...
          <tbody className='align-baseline'>
            {sitemap.map((location) =>
              location.category === category ? (
                <tr
                  key={location.page}
                  className='py-3 pr-2  border-b border-wine-100'
                >
