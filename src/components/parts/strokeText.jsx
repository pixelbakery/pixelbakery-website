...
const StrokeText = ({text, fontSize, strokeWidth, color, fontWeight}) => {
    ...
    width="100%" height="100%"  className="social-link transform transition-all duration-1000 ease-in-out text-blue-dark hover:fill-current hover:text-blue-dark motion-safe:hover:-skew-x-12" fill="none" stroke="currentColor" >
