...
export default function ServiceCard({project}){
    return(
        ...
        <article className={' portfolio-project aspect-w-3 xl:aspect-w-4 aspect-h-2 xl:aspect-h-3  w-full hover:opacity-90 hover:scale-95 ' + (project.isotopeTag)}  data-category={project.isotopeTag}>
