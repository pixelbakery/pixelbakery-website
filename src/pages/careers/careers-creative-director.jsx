              ...
              <section className="my-4 lander">
                    <div className='mx-auto max-w-6xl'>
                        ...
                        <div className="text-blue text-lg">
                              <p>Pixel Bakery is looking for someone to join our team as a full-time account executive.</p>
     
                              <p>You will prospect new clients, create lots of proposals, transfer the client on-boarding process to our internal team, build and foster client relationships, and be in constant communication with all active clients.</p>
     
                              <p>While our culture is extremely relaxed (you are allowed to set your own hours), things move very quickly around here. We’re a nimble team, which means you will have an enormous impact on our company and our work. You will learn to meet daily, weekly, and long-term deadlines in a fast-paced environment. Your days will vary greatly with a wide range of potential experiences. You will become a master of cold calling, and maybe even go across the country to help us find awesome new clients.</p>
                        </div>
                    </div>
              </section>
              <section className="bg-white py-12 my-4">
                   <div className="mx-auto flex gap-8">
                         ...
                         <div className="w-1/2 text-blue text-lg">
                              <p>As an integral part of a small studio with 7 people, we all wear multiple hats, you will too!</p>
                              <ul>
              ...
              <section className="bg-blue-dark py-12 my-4">
                   <div className="mx-auto flex gap-8">
                        <div className="w-1/2 flex flex-col justify-center px-8">
                         ...
                         <div className="w-1/2 flex flex-col justify-center px-8">
                              <p className="text-pink text-lg font-bold">We’d love to have you join the team. To apply, skip the cover letter and shoot us your resume and sales portfolio.</p>
                         </div>
                    </div>
