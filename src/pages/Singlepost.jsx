            ...
            <article className="" id="blog-body">
                ...
                <div className="" id="blog-body-intro">
                        ...
                        <div className="w-full flex mt-12 mb-8">
                            <Link to={"/jordan_lambrecht"}>
                                <img className="rounded-full h-16 w-16 flex items-center justify-center" src="./src/img/author2.png" alt="" />
                            </Link>
                            <div className="ml-8 h-16 flex flex-col justify-center">
                                <div className="text-sm text-wine">November 12, 2021 <span className="mx-4">|</span>Read Time: 4 minutes</div>
                                <div className="text-sm text-wine">Written by the one and only <a href="/" className="text-peach">Bergen Johnston</a></div>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <section className="my-12 md:max-w-3xl mx-auto" id="blog-body-guts ">
                        ...
                        <p className="text-lg text-wine my-3 pb-3">This is easy if you’re learning on the job–you probably have a project you need to complete. But if you’re learning on your own time, it’s important to have a goal in mind. Something like animating a character you designed to walk across the screen and wave, or creating a moving logo reveal for your brand. Don’t give up until you’re satisfied with the end result!</p>

                        <h2 className="text-wine text-4xl pt-6">Be patient with yourself.</h2>

                        <p className="text-lg text-wine my-4 pb-3">Learning something new takes time. Even if you’re a whiz at other Adobe programs, you might not intuitively understand everything right away when it comes to animating in Adobe After Effects. Let yourself be a beginner, and don’t let frustration or confusion overwhelm you from giving up on your goal.</p>

                        <h2 className="text-wine text-4xl pt-6" >Take things one step at a time.</h2>

                        <p className="text-lg text-wine my-3 pb-3">You’re going to have to start somewhere. Make a list of the things you need to learn or do in order to finish your goal project and start at the top. You might be surprised how quickly you can tick off each smaller task within the larger project–you can find a tutorial online for even the most specific questions. Tackling each element one by one is the best way to learn Adobe After Effects–you’ll start to notice that the skills you learn along the way will start building on each other, just like learning an instrument or a language.</p>
                    </section>
                    ...
                    <div className="grid grid-cols-3 gap-8 my-8 ">
                        <Link to={"/"}>
                            <article className="bg-white w-full aspect-h-4 pb-6 rounded transform hover:scale-95">
                                ...
                                <p className="text-wine my-4 py-2 px-4">yasdgasd asdfas df asdf asdfasdfj lakhw asdfasdfga </p>
                            </article>
                        </Link>
                        <Link to={"/"}>
