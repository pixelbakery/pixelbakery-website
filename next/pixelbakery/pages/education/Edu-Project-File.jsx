...
import ProjectImage from "../../img/polaroid.png";
      ...
      <section className='lander my-4 grid grid-cols-2'>
        ...
        <div className='col-span-1 h-full w-full overflow-hidden flex flex-col justify-center'>
          <div className='max-w-2xl px-8 mx-auto'>
            <div className='text-peach mb-0 pb-0 font-bold text-3xl lowercase'>
              Project File
            </div>
            <h1 className='text-blue-dark leading-none mt-0 pt-0'>
              polaroid camera
            </h1>
            <div>
              ...
              <p className='text-wine text-lg mb-8'>
                Energistically deliver real-time models with wireless quality
                vectors. Continually iterate plug-and-play portals via turnkey
                quality vectors. Globally build intermandated niche markets with
                equity invested infomediaries. Intrinsicly pursue orthogonal
                growth strategies after multimedia based innovation.{" "}
              </p>
              <Link
                to={"/"}
                className={"py-3 rounded-sm px-6 w-full text-center bg-blue"}
              >
