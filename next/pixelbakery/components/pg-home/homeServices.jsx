...
export default function Services() {
  ...
  return (
    <section
      className='relative py-16 bg-blue overflow-hidden'
      id='home-services'
    >
      <div className='relative max-w-6xl mx-auto z-10'>
        <div className=' w-full flex flex-col '>
          <div className='w-1/2 mb-16'>
            ...
            <p className='lead text-cream'>
              This is our craft. Our hobbies are our profession.
            </p>
          </div>
      ...
      <div
        className='absolute w-full max-w-md z-0 top-14 right-10'
        id='home-mixer'
      >
        <PbIconMixerAbs />
      </div>
