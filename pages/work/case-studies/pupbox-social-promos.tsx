...
const projectSubhead = "Bringing informative pup videos to social feeds forwarding brand awareness and recognition."
// A quick blurb that goes below the video but above the introduction
const projectExcerpt = 'Three puppy videos enhanced Pupbox’s brand voice on its social media channels.'
// Long form
