...
function BecomeAClient(){
     ...
     useLayoutEffect(() => {
          ...
          gsap.set("#expectation-3 .expect-numb",{ y:-100, rotation: gsap.utils.random(0, 15), delay: 0.5});
          let tl_ExpectationOne = gsap.timeline( { defaults: {  
              stagger: .1,
              ease: "power1.inOut",
            }, repeat:-1, repeatDelay:.44, yoyo:true } );
  
            let tl_ExpectationTwo = gsap.timeline( { defaults: {  
               stagger: .1,
               ease: "power1.inOut",
             }, repeat:-1} );

             let tl_ExpectationThree = gsap.timeline( { defaults: {  
               stagger: .1,
               ease: "power1.inOut",
             }, repeat:-1, repeatDelay:.66, yoyo:true } );
          ...
          tl_ExpectationTwo.to('#expectation-2   .expect-numb', {
               x: 100,
               rotation: -5,
               duration:1.22,
          }, "<+=1")
          .to('#expectation-2   .expect-numb', { 
               x: -100,
               rotation: 5,
               duration:1.22,
          }, "<+=3");
          ...
          <main className="">
               <section id="onboarding-contact" className="bg-yellow h-16 lander">
                   <div className="max-w-6xl mx-auto flex flex-col justify-center h-full"> 
                        <h1 className="my-4 text-blue-dark">Start something wonderful</h1>
                         ...
                         <p className="text-lg text-wine leading-loose max-w-xl">We don't do the pushy sales thing. We're here to make well-crafted, custom-tailored pieces of work for clients that we have a deep-rooted connection with. This means that we're highly selective when we take on a new client. We view it more as dating than making a sale. It's just as important that you like us and it is we like you.</p>
               ...
               <section id="onboarding-expectations my-4">
                    ...
                    <ExpectationsRow 
                         ...
                         bodyCopy={" We know that trust is something that is earned over time. Our initial projects with our clients usually start small. This is a relationship afterall, and it's important to us that both parties are happy and healthy."}
                    />
                    <ExpectationsRow 
                         flip={false}
                         number={"2"}
                         header={"We're not here to tell you what to do."}
                         bodyCopy={" Sure, we're probably better at animating than you are, but we'll never know your brand more intimately than you will. We can advise, strategize, suggest, and execute– but we won't barge in thinking we know what's best."}
                    />
                    <ExpectationsRow 
                         flip={true}
                         number={"3"}
